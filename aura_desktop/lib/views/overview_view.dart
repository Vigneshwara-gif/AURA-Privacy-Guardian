            ...
            children: [
              ...
              Expanded(
                child: _buildPostureQuadrant(
                  ...
                  subItems: [
                    'Camera: ${priv?.camera.summaryState ?? "Ready"}',
                    'Microphone: ${priv?.microphone.summaryState ?? "Ready"}',
              ...
              Expanded(
                child: _buildPostureQuadrant(
                  ...
                  title: 'BEHAVIOUR',
                  score: 100 - compRisk,
                  statusText: compRisk > 40 ? 'Anomalies Noted' : 'Nominal ML Baseline',
                  isHealthy: compRisk <= 40,
                  subItems: [
                    'Dual-Model AI: Active',
                    'Isolation Forest: Calibrated',
                    'LOF Local Density: Nominal',
                  ],
              ...
              Expanded(
                child: _buildPostureQuadrant(
                  ...
                  title: 'EXPOSURE',
                  score: (100 - (state.network?.publicIpCount ?? 0) * 10).toInt().clamp(0, 100),
                  statusText: '${state.network?.activeConnectionsCount ?? 0} Sockets Monitored',
                  isHealthy: (state.network?.publicIpCount ?? 0) < 5,
                  subItems: [
                    'Active Flows: ${state.network?.activeConnectionsCount ?? 0}',
                    'Public Endpoints: ${state.network?.publicIpCount ?? 0}',
                    'Listeners: ${state.network?.listeningPortsCount ?? 0}',
                  ],
